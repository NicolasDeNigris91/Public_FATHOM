...
**Encerramento:** após N03 você consegue ler logs HTTP, debug de DNS, configuração de TLS, sem chutar. CORS deixa de ser misterioso. Latência vira algo que você pode raciocinar (RTT, slow start, handshake) e medir.
