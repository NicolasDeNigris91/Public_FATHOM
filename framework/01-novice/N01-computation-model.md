...
- O **V8 GC** gerencia o heap (ver N07).
...
- **Conecta com [N02 — OS](N02-operating-systems.md):** virtual memory, page faults, mmap, working set são gerenciados pelo kernel. Cache locality também depende de scheduler (mover thread entre cores invalida cache local).
