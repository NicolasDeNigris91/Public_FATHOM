...
- Show units (`R$`, `kg`, `min`).
- Format separators ("1.234.567" pt-BR vs "1,234,567" en-US, A19).
...
- Diferenciar P17 (automated) e P18 (human-driven cognitive).
...
- Liga com **A02** (a11y básica): cognitive complementa visual/motor/auditory.
- Liga com **A19** (i18n): plain language atravessa idiomas.
- Liga com **P15** (incident response): erros legíveis em incident communication.
- Liga com **P17** (a11y testing): automated pega 30-40%; cognitive é o resto.
- Liga com **S05** (API design): error response humanos consumidos por client copy.
- Liga com **S16** (product/business): cognitive a11y bate como growth lever (conversion, churn, support load).
- Liga com **CAPSTONE-professional**: integration profunda em v2.
