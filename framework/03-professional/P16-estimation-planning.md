...
# P16 — Estimation & Technical Planning
...
Soma de tasks com PERT dá distribuição do projeto. Útil quando alguém pede single number — você sabe que P10 é fantasia e P90 é cobertura.
...
Conduzir **planejamento técnico do CAPSTONE-professional** (Logística v2) end-to-end. Output é doc + execução observável.
...
- Liga com **P01** (testing): TDD afeta cycle time; spikes feedback.
- Liga com **P04** (CI/CD): deploy frequency = throughput proxy.
- Liga com **P07/P15** (obs / incident): unplanned work consume budget.
- Liga com **S07** (architectures): refactor estima diferente de greenfield.
- Liga com **S08** (services vs monolith): cada arquitetura tem cycle time signature.
- Liga com **S12** (tech leadership): RFC, ADR, comunicação técnica.
- Liga com **S16** (product/business): roadmap alignment com unit economics.
- Liga com **CAPSTONE-professional / senior**: planning é parte da entrega.
