...
Closures explicam: módulos com estado privado, factories, callbacks com contexto. Aprofundamento em [01-07](01-07-javascript-deep.md).
...
**Encerramento:** após 01-06 você para de escolher paradigma por inércia. Cada decisão de design (classe vs função, mutável vs imutável, herança vs composição) vira uma escolha consciente baseada no problema.
