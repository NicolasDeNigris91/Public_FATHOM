...
Como em S01: at-most, at-least, "exactly-once processing".
...
- Liga com **A11** (Redis): Streams como light alternative.
- Liga com **A12** (Mongo): Change Streams como CDC light.
- Liga com **P03** (K8s): Strimzi Operator pra Kafka.
- Liga com **P05** (AWS): MSK, Kinesis, EventBridge.
- Liga com **P07** (observability): consumer lag como SLO.
- Liga com **S01** (theory): consensus em controllers, ISR, ordering.
- Liga com **S03** (event-driven): patterns sobre essa fundação.
- Liga com **S04** (resilience): retry, DLQ, circuit breakers ao consumer.
- Liga com **S08** (services): broker é veículo de microservices comm.
