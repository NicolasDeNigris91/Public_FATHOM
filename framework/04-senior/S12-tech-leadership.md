...
Decisão recorrente:
- Auth: Auth0/Clerk vs build. (A13 cobriu).
...
4. **Postmortem**:
   - Incidente do P07/CAPSTONE-professional escrito como postmortem blameless.
...
- Liga com **N09** (Git): commit hygiene, branch strategy.
- Liga com **P04** (CI/CD): DORA metrics, deployment culture.
- Liga com **P07** (observability): SLO conversation pra business.
- Liga com **P08** (security): security as culture.
- Liga com **S06** (DDD): conversa stakeholders → ubiquitous language.
- Liga com **S07-S09** (architecture, services, scaling): decisões fundamentadas em ADRs.
