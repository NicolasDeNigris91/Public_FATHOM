...
## Estágio 1 — Novice (Fundamentos & CS)
...
### Search & Information Retrieval (A15)
...
### Internationalization & Localization (A19)
...
## Estágio 3 — Professional (Ecossistema, Operações)
...
### Time-Series & Analytical DBs (P13)
- **Database Internals** (Alex Petrov) — também aplicável em S09.
...
### Estimation & Technical Planning (P16)
...
### Accessibility Testing (P17)
- **Inclusive Design Patterns** (Heydon Pickering) — também aplicável em A02.
...
## Estágio 4 — Senior (Arquitetura Distribuída)
...
### Streaming & Batch Processing (S13)
...
### Product, Business & Unit Economics (S16)
...
### Conway's Law & Org Architecture (ST03)
...
- **How Amazon Web Services Uses Formal Methods** (Newcombe et al) — pra **S14**.

Encontre todos em [paperswelove.org](https://paperswelove.org/) ou [arxiv.org](https://arxiv.org/). ST04 estabelece protocolo de leitura.
