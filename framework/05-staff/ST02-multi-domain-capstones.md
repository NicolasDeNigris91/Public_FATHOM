...
- **Ledger** (revisita A18) com double-entry.
...
- **Embed support**: GIF, image upload com S3/MinIO.
- **Export**: PNG, SVG.

Tech stack: TypeScript + WebSocket server + Yjs + Canvas/WebGL (P14 conexão) + Postgres.
...
- **Retrieval**: hybrid (BM25 + vector, A15 conexão).
- **LLM call**: provider API com prompt engineering, citations (ver S10).
...
- Fintech ledger → improve A18 patterns.
...
- Open source com expectativas claras (S15).
- Submission a conferência por capstone mais interessante.
- Mentor outro engineer através de um deles (overlap com ST06).

---

## 5. Extensões e Conexões

- Liga com **CAPSTONE-novice/apprentice/professional/senior**: variation domain.
- Liga com **A18** (payments): fintech capstone reuses ledger.
- Liga com **A14** (real-time): whiteboard capstone exercise WS.
- Liga com **A15** (search): RAG depende de hybrid retrieval.
- Liga com **S10** (AI/LLM): RAG é caso central.
- Liga com **P14** (graphics): whiteboard renderiza canvas.
- Liga com **ST05** (public output): blog posts derivam.
- Liga com **ST06** (mentorship): tutorar outro pelo seu capstone.
