...
# ST08 — Hardware Design Fundamentals (Optional)

## 1. Problema de Engenharia

ST07 cobriu firmware (software rodando em microcontroller). Mas Logística pode crescer pra criar **hardware próprio** — tracker custom com sensores específicos, leitor de barcode integrado, smart locker, beacon BLE proprietary. Aí entra hardware design: schematics, PCB layout, BOM, manufacturing.
...
Bring-up de protótipo é onde firmware (ST07) e hardware se encontram. Conhecer ambos lados acelera.
...
- ARM Cortex-M4 (STM32 ou ESP32-S3).
...
- **Firmware skeleton** integrado com ST07 implementation.
...
- Liga com **N02** (OS): bare metal, drivers, syscalls em microkernel.
- Liga com **N14** (CPU microarchitecture): conhecimento sobe ao nível ASIC/SoC design.
- Liga com **N12** (cripto): secure element, hardware security.
- Liga com **ST07** (embedded): firmware roda neste hardware.
- Liga com **CAPSTONE-staff** track A/B/G: opção pra eixo IoT/hardware/robotics.
