...
# ST03 — Conway's Law & Org Architecture
...
Staff/Principal **desenha o time**, não só o código. Recommend split do time em squads aligned com bounded contexts (DDD, S06). Argumenta com VP/CTO sobre quando decompor, quando consolidate, quando criar platform team. Reduz dependency hell entre teams. Identifica quando "a arquitetura é ruim porque o org chart é ruim" — frequentemente o caso.
...
### 2.4 Bounded contexts (S06) ↔ teams
...
- Pagamentos team owns Payments context (A18).
...
- Liga com **S06** (DDD): bounded contexts.
- Liga com **S07** (architectures): hexagonal/clean são intra-team patterns.
- Liga com **S08** (services vs monolith): Conway dirige escolha.
- Liga com **S12** (tech leadership): RFC, ADR, comunicação técnica.
- Liga com **S15** (OSS maintainership): governance é mini-org design.
- Liga com **S16** (product/business): structure influences velocity.
- Liga com **ST05** (public output): blogging org thoughts.
- Liga com **ST06** (mentorship): mentor é alavanca cross-team.
- Liga com **CAPSTONE-staff**: choice de specialization implies team topology onde você cabe.
